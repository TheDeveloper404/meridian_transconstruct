        ...
        <div className="container px-4 mx-auto">
          <div className="p-8 border rounded-xl border-slate-800 bg-slate-900 md:p-10">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <Link to="/servicii" className="p-5 transition border rounded-lg border-slate-700 hover:border-blue-400/50 hover:-translate-y-1">
                <h3 className="mb-2 text-xl font-semibold">Servicii</h3>
                <p className="text-slate-300">Vezi exact ce tipuri de lucrări executăm.</p>
              </Link>
              <Link to="/proiecte" className="p-5 transition border rounded-lg border-slate-700 hover:border-blue-400/50 hover:-translate-y-1">
              ...
              <Link to="/contact" className="p-5 transition border rounded-lg border-slate-700 hover:border-blue-400/50 hover:-translate-y-1">
