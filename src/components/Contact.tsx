          ...
          <div className="p-8 border rounded-xl border-slate-800 bg-slate-900">
            ...
            <form className="space-y-4">
              <input
                type="text"
                placeholder="Nume"
                className="w-full px-4 py-3 border rounded-md outline-none bg-slate-950 border-slate-700 focus:border-blue-400"
              />
              <input
                type="tel"
                placeholder="Telefon"
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border rounded-md outline-none resize-none bg-slate-950 border-slate-700 focus:border-blue-400"
              />
              <button
                type="button"
