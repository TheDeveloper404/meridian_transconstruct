...
export function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className="fixed z-50 inline-flex items-center gap-2 px-4 py-3 text-sm font-semibold text-white transition-colors bg-blue-600 rounded-full shadow-lg right-5 bottom-5 hover:bg-blue-500"
    >
      <svg
