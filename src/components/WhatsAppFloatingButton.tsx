...
export function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className="fixed z-50 inline-flex items-center justify-center w-16 h-16 text-white transition-colors bg-green-500 rounded-full shadow-xl right-5 bottom-5 hover:bg-green-600"
    >
      <svg
